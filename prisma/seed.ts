...
const products = [
  {
    ...
    description: "Японська сенча з ніжним трав'яним смаком та легкою солодкістю. Збирається ранковою росою на високогірних плантаціях. Ідеальна для спокійного ранку.",
    price: 320,
    weight: "50 г",
    origin: "Японія",
    image: "https://images.unsplash.com/photo-1556671047-27be167aa984?w=800&q=80",
  ...
  },
  {
    ...
    description: "Легендарний китайський зелений чай з гори Сіху. Плоскі листки, що нагадують мечі дракона, розкривають свіжий горіховий смак.",
    price: 450,
    weight: "50 г",
    origin: "Китай",
    image: "https://images.unsplash.com/photo-1564890369478-c89ca6d9cde9?w=800&q=80",
  ...
  },
  {
    ...
    description: "Міцний індійський чорний чай з малайзьких долин. Насичений, з нотками солодкого сухофрукту та меду.",
    price: 280,
    weight: "100 г",
    origin: "Індія",
    image: "https://images.unsplash.com/photo-1594631252845-29ada4c84f71?w=800&q=80",
  ...
  },
  {
    ...
    description: "Класичний Earl Grey з bergamot та нотками ванілі. Вишуканий бленд для вечірнього чаювання.",
    price: 350,
    weight: "100 г",
    origin: "Шрі-Ланка",
  ...
  },
  {
    ...
    description: "Преміальний тайванський улун з квітковим ароматом та кремовою текстурою. Кожне заварювання розкриває нові грані смаку.",
    price: 580,
    weight: "50 г",
    origin: "Тайвань",
    image: "https://images.unsplash.com/photo-1576092760541-0963b9bb6409?w=800&q=80",
  ...
  },
  {
    ...
    description: "Легендарний скельний улун з Уишань. Димний, мінеральний смак з довгим післясмаком.",
    price: 720,
    weight: "30 г",
    origin: "Китай",
    image: "https://images.unsplash.com/photo-1544787210-86dba7b5c72c?w=800&q=80",
  ...
  },
  {
    ...
    description: "Сирий пуер з древніх чайних дерев. Свіжий, з нотками квітів та легкою гірчинкою, що змінюється з віком.",
    price: 890,
    weight: "50 г",
  ...
  },
  {
    ...
    description: "Витриманий ферментований пуер з м'яким, землистим смаком. Зігріває та заспокоює.",
    price: 650,
    weight: "50 г",
    origin: "Китай, Юньнань",
  ...
  },
  {
    ...
    description: "Ніжний трав'яний збір для вечірнього розслаблення. Заспокоює нервову систему та покращує сон.",
    price: 180,
    weight: "50 г",
    origin: "Україна",
  ...
  },
  {
    name: "Імбир & Лимон",
    slug: "ymbyr-lymon",
    description: "Бадьорий збір з імбиру, лимону та м'яти. Зігріває та підвищує імунітет.",
    price: 200,
    weight: "50 г",
    origin: "Україна",
